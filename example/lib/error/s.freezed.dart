...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  zero,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Zero() when zero != null:
return zero();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  zero,}) {final _that = this;
switch (_that) {
case Zero():
return zero();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  zero,}) {final _that = this;
switch (_that) {
case Zero() when zero != null:
return zero();case _:
  return null;
