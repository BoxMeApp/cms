...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( Pop value)?  pop,TResult Function( FetchNote value)?  fetchNote,TResult Function( NewContent value)?  newContent,required TResult orElse(),}){
final _that = this;
switch (_that) {
case Pop() when pop != null:
return pop(_that);case FetchNote() when fetchNote != null:
return fetchNote(_that);case NewContent() when newContent != null:
return newContent(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( Pop value)  pop,required TResult Function( FetchNote value)  fetchNote,required TResult Function( NewContent value)  newContent,}){
final _that = this;
switch (_that) {
case Pop():
return pop(_that);case FetchNote():
return fetchNote(_that);case NewContent():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( Pop value)?  pop,TResult? Function( FetchNote value)?  fetchNote,TResult? Function( NewContent value)?  newContent,}){
final _that = this;
switch (_that) {
case Pop() when pop != null:
return pop(_that);case FetchNote() when fetchNote != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  pop,TResult Function( int? id)?  fetchNote,TResult Function( String content)?  newContent,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Pop() when pop != null:
return pop();case FetchNote() when fetchNote != null:
return fetchNote(_that.id);case NewContent() when newContent != null:
return newContent(_that.content);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  pop,required TResult Function( int? id)  fetchNote,required TResult Function( String content)  newContent,}) {final _that = this;
switch (_that) {
case Pop():
return pop();case FetchNote():
return fetchNote(_that.id);case NewContent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  pop,TResult? Function( int? id)?  fetchNote,TResult? Function( String content)?  newContent,}) {final _that = this;
switch (_that) {
case Pop() when pop != null:
return pop();case FetchNote() when fetchNote != null:
return fetchNote(_that.id);case NewContent() when newContent != null:
