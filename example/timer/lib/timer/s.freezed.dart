...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int duration)?  zero,TResult Function( int duration,  StreamSubscription<int> subscription)?  paused,TResult Function( int duration,  StreamSubscription<int> subscription)?  running,TResult Function( int duration)?  completed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Zero() when zero != null:
return zero(_that.duration);case Paused() when paused != null:
return paused(_that.duration,_that.subscription);case Running() when running != null:
return running(_that.duration,_that.subscription);case Completed() when completed != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int duration)  zero,required TResult Function( int duration,  StreamSubscription<int> subscription)  paused,required TResult Function( int duration,  StreamSubscription<int> subscription)  running,required TResult Function( int duration)  completed,}) {final _that = this;
switch (_that) {
case Zero():
return zero(_that.duration);case Paused():
return paused(_that.duration,_that.subscription);case Running():
return running(_that.duration,_that.subscription);case Completed():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int duration)?  zero,TResult? Function( int duration,  StreamSubscription<int> subscription)?  paused,TResult? Function( int duration,  StreamSubscription<int> subscription)?  running,TResult? Function( int duration)?  completed,}) {final _that = this;
switch (_that) {
case Zero() when zero != null:
return zero(_that.duration);case Paused() when paused != null:
return paused(_that.duration,_that.subscription);case Running() when running != null:
...
class Paused implements S {
  const Paused(this.duration, this.subscription);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Paused&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.subscription, subscription) || other.subscription == subscription));
}


@override
int get hashCode => Object.hash(runtimeType,duration,subscription);

@override
String toString() {
  return 'S.paused(duration: $duration, subscription: $subscription)';
}
...
@override @useResult
$Res call({
 int duration, StreamSubscription<int> subscription
});
...
/// Create a copy of S
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? duration = null,Object? subscription = null,}) {
  return _then(Paused(
null == duration ? _self.duration : duration // ignore: cast_nullable_to_non_nullable
as int,null == subscription ? _self.subscription : subscription // ignore: cast_nullable_to_non_nullable
...
class Running implements S {
  const Running(this.duration, this.subscription);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Running&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.subscription, subscription) || other.subscription == subscription));
}
...
@override
String toString() {
  return 'S.running(duration: $duration, subscription: $subscription)';
}
